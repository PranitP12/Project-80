...
import { Text, View, Image, ImageBackground, TouchableOpacity, StyleSheet, Platform, StatusBar, SafeAreaView, Linking, ScrollView, ToastAndroid } from 'react-native';
...
export default class DailyPicScreen extends Component {
    ...
    getAPOD = () => {
        axios
            .get("https://api.nasa.gov/planetary/apod?api_key=bSnyBUB6rR80178prjHwGdAOncjiAmysxHv1IY8O")
            .then(response => {
